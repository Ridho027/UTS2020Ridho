package com.example.uts_amub_ti7a_1711500081_ridho;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        blog.setOnClickListener (new View.OnClickListener(){
            public void onClick(View view){
                Intent gotonextregister = new Intent(MainActivity.this, RegisterOneAct.class);
        ...
        breg.setOnClickListener (new View.OnClickListener(){
            public void onClick(View view){
                Intent gotologin = new Intent(MainActivity.this, RegisterTwoAct.class);
